...
def test_instances(update_specification_tool_path):
    test_instances_structure = {
        ...
        "Flow cycle": [
            ...
            YesNoQuestion("In workflow 'package2.MainWorkflow', is there a cycle in the control flow directly in the workflow (not inside any of the subworkflows)?", False),
    ...
    test_instances_semantics = {
        "Inconsistent task name and description": [
            ...
            TaskListOpenQuestion(
                "Identify tasks in 'automl_ideko.FailurePredictionInManufacture', whose name does not correspond with their description.",
        ...
        "Inconsistent descriptions": [
            update_specification_tool_path("automl_wrong_implementation"),
            TaskListOpenQuestion(
                "Identify tasks in workflow 'automl_ideko.FailurePredictionInManufacture' (including tasks in the subworkflows), whose description does not correspond with the description of the workflow.", {
